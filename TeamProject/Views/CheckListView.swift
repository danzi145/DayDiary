...
//
    ...
    func getCheckTableView() -> UITableView {
...
//        textView.addSubview(memoTextView)
        ...
        checkView.addSubview(checkTableView)
...
//
        ...
        checkTableView.translatesAutoresizingMaskIntoConstraints = false
...
//            checkView.bottomAnchor.constraint(equalTo: bottomButtonView.topAnchor),
            ...
            checkTableView.topAnchor.constraint(equalTo: checkView.topAnchor),
            checkTableView.leadingAnchor.constraint(equalTo: checkContentsView.trailingAnchor, constant: 5),
            checkTableView.trailingAnchor.constraint(equalTo: checkView.trailingAnchor),
            checkTableView.bottomAnchor.constraint(equalTo: checkView.bottomAnchor),
